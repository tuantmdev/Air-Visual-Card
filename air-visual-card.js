class AirVisualCard extends HTMLElement {
  ...
  set hass(hass) {
    ...
    const ICON = {
      '1': 'ic-face-1-green.svg',
      '2': 'ic-face-2-yellow.svg',
      '3': 'ic-face-3-orange.svg',
      '4': 'ic-face-4-red.svg',
      '5': 'ic-face-5-purple.svg',
      '6': 'ic-face-6-maroon.svg'
    };
    const AQIbgColor = {
      '1': `#A8E05F`,
      '2': '#FDD74B',
    ...
    <div class="face" style="background-color: ${AQIfaceColor[getAQI()]};">
      <img src="air-visual-resources/${ICON[getAQI()]}" />
    </div>
    ...
    <div class="temp">
      <div class="weather">
        ...
        <span style="font-size:1.2em;">${temp}</span>
      </div>
    </div>
    <div class="humidity">
      <div class="weather">
